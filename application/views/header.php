...
<head>
  ...
  <!--Titulo--> 
  <title>BASEO - Buy and Sell Easy Online</title>
  <!--Css-->
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ml-auto" style="background-color:#F17187">
                ...
                <li class="nav-item">
                  <a data-scroll="" class="nav-link section-scroll" href="#services-d"><span style="color:#FFF">Products</span></a>
                </li>
                <li class="nav-item">
                  <a data-scroll="" class="nav-link section-scroll" href="#team"><span style="color:#FFF">Services</span></a>
                </li>
                <li class="nav-item">
                  <a data-scroll="" class="nav-link section-scroll" href="blog.html"><span style="color:#FFF">Login</span></a>
                </li>
              </ul>
