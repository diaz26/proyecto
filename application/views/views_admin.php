...
<html lang="en">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#">Administrar <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <form action="<?= base_url(); ?>index.php/Login/cambiar_clave/" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">Cambiar clave de acceso</label>
    <input type="text" name="usuario" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enterioga email">
