      ...
      <div class="container" style="background-color:<?= $page->nav_bg; ?>">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto" style="background-color:<?= $page->nav_bg; ?>">
            <li class="nav-item">
              <a data-scroll="" class="nav-link section-scroll" href="<?= base_url(); ?>index.php/welcome/to/<?= $page->nombre; ?>"><span style="font-size: 16px;color:<?= $page->nav_color; ?>">Productos</span></a>
            </li>
          </ul>
